...
import BlindHelpScene.AdapterAndTemplateMethod.*;

public class AdapterAndTemplateMethodTest {
    ...
    public static void main(String[] args) {
        System.out.println("------------Adapter & Template Method test in BlindHelpScene------------");
        // 构造两种指南
